...
public final class DatabaseModule_ProvideHistoryDaoFactory implements Factory<HistoryDao> {
  ...
  public DatabaseModule_ProvideHistoryDaoFactory(Provider<AzHuaDatabase> dbProvider) {
  ...
  public static DatabaseModule_ProvideHistoryDaoFactory create(Provider<AzHuaDatabase> dbProvider) {
    return new DatabaseModule_ProvideHistoryDaoFactory(dbProvider);
  }

  public static HistoryDao provideHistoryDao(AzHuaDatabase db) {
